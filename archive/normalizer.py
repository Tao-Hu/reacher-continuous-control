...
# see https://github.com/openai/baselines/blob/master/baselines/common/running_mean_std.py
...
# taken from ShangtongZhang/DeepRL
# see https://github.com/ShangtongZhang/DeepRL/blob/master/deep_rl/utils/normalizer.py
